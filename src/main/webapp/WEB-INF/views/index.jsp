...
<body>
    ...
    <main class="flex-shrink-0">
        ...
        <div class="container">
            <section class="mt-5">
                <h1 text-bg-dark>¡Bienvenido a Prevent!</h1>
                <p>En nuestra compañía, nos dedicamos a brindar asesorías en prevención de riesgos laborales, y hemos identificado un desafío común para muchas empresas: la falta de una solución tecnológica que facilite la administración de los procesos necesarios para cumplir con la normativa vigente y mejorar las condiciones de trabajo. Es por eso que hemos desarrollado una solución integral que aborda estas necesidades y ayuda a optimizar la gestión en prevención de riesgos laborales.</p>
                <h2>PROBLEMA:</h2>
